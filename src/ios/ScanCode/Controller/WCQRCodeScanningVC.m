...
@interface WCQRCodeScanningVC () <SGQRCodeScanManagerDelegate>
...
-(void)setCancelBtn{
    UIButton * btn = [[UIButton alloc]initWithFrame:CGRectMake(ScreenW/2-40, ScreenH-50-20-49, 80, 40)];
    [btn setTitle:@"取消" forState:UIControlStateNormal];
    [btn setTintColor:[UIColor whiteColor]];
    btn.backgroundColor = [UIColor clearColor];
    [btn addTarget:self action:@selector(closeModal) forControlEvents:UIControlEventTouchUpInside];
